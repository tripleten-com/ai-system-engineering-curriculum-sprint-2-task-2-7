...
Purpose:           Validate Task 2.7 answers and the permitted change paths.
...
ALLOWED_PREFIXES = ("config/student/", "tests/student/")
...
def main(root: Path | None = None, *, changed_paths: list[str] | None = None) -> int:
    ...
    try:
        ...
        return 1
    print("Task 2.7 answer verification passed.")
    return 0
